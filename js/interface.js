function panel() {
    if (level != 0) {
        ...
        c.strokeText("SCORE: " + score, 150 + (canvas.width - currentScreenWidth) / 2, 28)
        c.fillText("SCORE: " + score, 150 + (canvas.width - currentScreenWidth) / 2, 28)
        c.strokeText("HIGH SCORE: " + highScore, 340 + (canvas.width - currentScreenWidth) / 2, 28)
        c.fillText("HIGH SCORE: " + highScore, 340 + (canvas.width - currentScreenWidth) / 2, 28)
        c.fillStyle = "#16db7f"
