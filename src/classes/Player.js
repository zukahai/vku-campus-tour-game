                ...
                setTimeout(() => {
                    proyectiles.push(
                        new Sprite({
                            ...
                            imageSrc: './assets/img/proyectiles/naranja.png',
                            frameRate: 1,
                            frameBuffer: 2,
                            scale: 1,
                        ...
                        if(obj[i] != undefined && obj[i].vida <= 0) {
                            ...
                            efectoEnemigos.push(
                                new Sprite({
                                    ...
                                    imageSrc: './assets/img/enemigos/hit2.png',
                                    frameRate: 6,
                                    frameBuffer: 6,
                                    scale: 1,
                                    identificador: 'hit',
                        ...
                        if(obj[i] != undefined && obj[i].identificador === 'disparoE' && obj[i].vida <= 0 ) {
                            ...
                            efectoProyectilesEnemigos.push(
                                new Sprite({
                                    ...
                                    imageSrc: './assets/img/proyectiles/'+sour+'.png',
                                    frameRate: fra,
                                    frameBuffer: 4,
                                    scale: sca,
            ...
            obj[i] != undefined && obj[i].identificador === 'disparo' && obj[i].position.x < obj[i].posicion - 250) {
                ...
                efectoProyectiles.push(
                    new Sprite({
                        ...
                        imageSrc: './assets/img/proyectiles/hit.png',
                        frameRate: 5,
                        frameBuffer: 4,
                        scale: 2,
                        identificador: 'explo',
                ...
                if(obj[i] != undefined && obj[i].identificador != 'nivel' && obj[i].identificador != 'ganar') {
                    efectoObjetos.push(
                        new Sprite({
                            ...
                            imageSrc: './assets/img/objetos/'+obj[i].hitboxO.sourc+'.png',
                        ...
                        if(enemigos[i].vida >= 1) {
                            proyectilesEnemigos.push(
                                new Sprite({
                                    ...
                                    imageSrc: './assets/img/proyectilesEnemigos/'+sourc+'.png',
                                    frameRate: rate,
                                    frameBuffer: 10,
                                    scale: scal,
        ...
        if(lives >= 1 && ganar === false) {
            enemigos.push(
                new Sprite({
                    ...
                    imageSrc: './assets/img/enemigos/murcielagoRL.png',
                    frameRate: 3,
                    frameBuffer: 6,
                    loop: true,
                    autoplay: true,
                    ...
                    animations: {
                        idleR:{
                            ...
                            loop: true,
                            autoplay: true,
                            imageSrc: './assets/img/enemigos/murcielagoRR.png',
                        },
                        idleL:{
                            frameRate: 3,
                            frameBuffer: 6,
